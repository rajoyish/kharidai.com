                ...
                <div className="grid gap-4 border-l-2 border-primary/20 py-2 pl-4">
                    ...
                    {showHourlyRate && (
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                min="0"
                                value={
                                    data.pricing_config?.hourly_rate_npr || ''
                                }
                                onChange={(e) =>
                                    updateConfig(
                                        'hourly_rate_npr',
                            ...
                            />
                            {errors['pricing_config.hourly_rate_npr'] && (
                                <div className="text-sm text-destructive">
                                    {errors['pricing_config.hourly_rate_npr']}
                                </div>
                            )}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    min="0"
                                    value={
                                        data.pricing_config?.cover_rate_npr ||
                                        ''
                                    }
                                    onChange={(e) =>
                                        updateConfig(
                                ...
                                />
                                {errors['pricing_config.cover_rate_npr'] && (
                                    <div className="text-sm text-destructive">
                                        {
                                            errors[
                                                'pricing_config.cover_rate_npr'
                                            ]
                                        }
                                    </div>
                                )}
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    min="0"
                                    value={
                                        data.pricing_config?.inner_rate_npr ||
                                        ''
                                    }
                                    onChange={(e) =>
                                        updateConfig(
                                ...
                                />
                                {errors['pricing_config.inner_rate_npr'] && (
                                    <div className="text-sm text-destructive">
                                        {
                                            errors[
                                                'pricing_config.inner_rate_npr'
                                            ]
                                        }
                                    </div>
                                )}
                    ...
                    {showTiers && (
                        <div className="grid gap-3">
                            ...
                            {errors['pricing_config.tiers'] && (
                                <div className="text-sm text-destructive">
                                    {errors['pricing_config.tiers']}
                                </div>
                            )}

                            {(data.pricing_config?.tiers || []).map(
                                    ...
                                    >
                                        <div className="grid flex-1 grid-cols-1 gap-4 md:grid-cols-3">
                                            <div>
                                                ...
                                                />
                                                {errors[
                                                    `pricing_config.tiers.${index}.key`
                                                ] && (
                                            ...
                                            <div>
                                                ...
                                                />
                                                {errors[
                                                    `pricing_config.tiers.${index}.label`
                                                ] && (
                                                    <div className="mt-1 text-xs text-destructive">
                                                        {
                                                            errors[
                                            ...
                                            <div>
                                                ...
                                                />
                                                {errors[
                                                    `pricing_config.tiers.${index}.price_npr`
                                                ] && (
                                                    <div className="mt-1 text-xs text-destructive">
                                                        {
                                                            errors[
                            ...
                            {(data.pricing_config?.tiers || []).length ===
                                0 && (
                ...
                <div className="grid gap-4">
                    <div className="flex items-center gap-2">
                        <Switch
                            ...
                            onCheckedChange={(checked) =>
                                setData('requires_brief', checked)
                            }
                        />
                        <Label htmlFor="requires_brief">
                            Requires a project brief from client
                        </Label>
                    </div>
                    {errors.requires_brief && (
                        <div className="text-sm text-destructive">
                            {errors.requires_brief}
                        </div>
                    )}
                    ...
                    <div className="flex items-center gap-2">
                        <Switch
                            ...
                            onCheckedChange={(checked) =>
                                setData('requires_contract', checked)
                            }
                        />
                        <Label htmlFor="requires_contract">
                            Requires a signed contract before starting
                        </Label>
                    </div>
                ...
                <div className="grid gap-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setData('revisions', e.target.value)
                            }
                        />
                        {errors.revisions && (
                            <div className="text-sm text-destructive">
            ...
            <div className="grid gap-4 border-t pt-4">
                <div className="flex items-center gap-2">
                    <Switch
                        ...
                        onCheckedChange={(checked) =>
                            setData('requires_advance', checked)
                        }
                    />
                    <Label htmlFor="requires_advance">
                        Requires an advance payment
                    </Label>
                </div>
                {errors.requires_advance && (
                    <div className="text-sm text-destructive">
                        {errors.requires_advance}
                    </div>
                )}
                ...
                {data.requires_advance && (
                    <div className="grid grid-cols-1 gap-4 border-l-2 border-primary/20 py-2 pl-4 md:grid-cols-2">
                        <div className="grid gap-2">
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setData('advance_type', e.target.value)
                                }
                            >
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData('advance_value', e.target.value)
                                }
                            />
                            {errors.advance_value && (
                                <div className="text-sm text-destructive">
                                    {errors.advance_value}
                                </div>
                            )}
